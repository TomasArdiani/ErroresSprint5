...
//const productosModel = require('../database/models/pro');
...
let productosController = {
    ...
    update: (req, res) => {
        ...
        let cantFilasActualizadas = /*await*/ db.productos.update({ //update a product
            ...req.body
    ...
    detail: (req, res) => {
        ...
        const producto = db.productos.findOne({
            where: {
