...
-- -----------------------------------------------------
-- Table `home_gym`.`clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `home_gym`.`clientes` (
...
-- -----------------------------------------------------
-- Table `home_gym`.`imagenes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `home_gym`.`imagenes` (
  `imagenes_id` INT(11) NOT NULL,
  `producto_id` VARCHAR(45) NULL DEFAULT NULL,
  `ruta_imagen` VARCHAR(45) NULL DEFAULT NULL,
